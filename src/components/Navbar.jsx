...
const Navbar = () => {
  ...
  return (
    <motion.div initial={{opacity: 0, y: -50}} animate={{opacity: 1, y:0}} transition={{duration: 0.3}}>
      <nav className="fixed top-12 items-center md:left-1/2 md:transform -translate-x-1/2 bg-zinc-900/30 md:backdrop-blur-lg text-white font-sans rounded-2xl shadow-lg md:px-6 px-5 py-3 md:flex md:justify-around gap-6 z-2 left-[88%]">
